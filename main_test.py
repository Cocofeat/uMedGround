...
def parse_args(args):
    ...
    parser.add_argument("--weight", default="./runs/lisa/ckpt_model/pytorch_model.bin", type=str) # Llava withou SAM for mimic
    ...
    parser.add_argument("--evidential_head", action="store_true", default=False)
    ...
    parser.add_argument("--mhp_box_head", action="store_true", default=True)
...
def test(test_loader, model_engine, tokenizer, writer, prompter, args):
    ...
    for input_dict in tqdm.tqdm(test_loader):
        ...
        if args.uncertain_box_head or args.evidential_head or args.mhp_box_head or args.Umhp_box_head:
    ...
    if args.uncertain_box_head or args.evidential_head or args.mhp_box_head:
    ...
    if not os.path.exists("./"+"p_" + args.vis_save_path): 
